...
7.  **[08_extension-fase1-examples.md](08_extension-fase1-examples.md)**: Plan de extensión de ejemplos del SDK a todos los runtimes (Deno, Bun, frameworks, bundlers).
