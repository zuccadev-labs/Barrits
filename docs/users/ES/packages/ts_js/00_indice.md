# 00 Indice de uso de ts_js

Yo uso esta carpeta para documentar como instalo `barrits`, como empiezo a consumirlo y que practicas sigo para no pelearme con la automatizacion del paquete.

Orden de lectura:

1. `01_instalacion.md`: yo explico como instalo el paquete y que prerequisitos asumo.
2. `02_primeros-pasos.md`: yo muestro como configuro un proyecto consumidor minimo.
3. `03_ejemplos-y-recorridos.md`: yo relaciono cada ejemplo real del repo con un caso de uso y desde ahi bajo a `examples/` cuando necesito mas detalle.
