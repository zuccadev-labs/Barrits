/**
 * [EN] Returns the element whose projected value is the largest. Ties keep the first occurrence.
 ...
 * [ES] Devuelve el elemento cuyo valor proyectado es el mayor. En caso de empate se conserva la primera aparición.
 ...
 * @returns [EN] The element with the maximum value, or undefined if empty. [ES] El elemento con el valor máximo, o undefined si está vacía.
 */
