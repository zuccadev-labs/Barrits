...
export declare const barrits: {
  ...
  logic: {
    aggregateAlgorithms: {
      ...
      histogramBy: <Value, Key extends string | number>(
    ...
    algorithms: {
      ...
      graph: {
        breadthFirstSearch: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
          startNode: NodeId,
        ) => NodeId[];
        buildAdjacencyList: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
          options?: {
            readonly directed?: boolean;
          },
        ) => Map<NodeId, import("./flat").GraphAdjacencyEntry<NodeId>[]>;
        detectDirectedCycle: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
        ) => NodeId[] | null;
        depthFirstSearch: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
          startNode: NodeId,
        ) => NodeId[];
        dijkstraShortestPath: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
          startNode: NodeId,
          targetNode: NodeId,
        ) => import("./flat").GraphPath<NodeId>;
        maxFlow: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
          source: NodeId,
          sink: NodeId,
        ) => import("./flat").MaxFlowResult<NodeId>;
        minimumSpanningTree: <NodeId extends import("./flat").GraphNodeId>(
          edges: readonly import("./flat").GraphEdge<NodeId>[],
        ) => import("./flat").MinimumSpanningTreeResult<NodeId>;
      ...
      search: {
        ...
        findSortedRange: <Value>(
          values: readonly Value[],
          target: Value,
          compare?: import("./flat").CompareFunction<Value>,
        ) => import("./flat").SortedRangeMatch;
      ...
      selection: {
        ...
        ) => import("./flat").PartitionResult<Value>;
        rankBy: <Value>(
          values: readonly Value[],
          criteria: readonly import("./flat").OrderCriterion<Value>[],
        ) => import("./flat").RankedValue<Value>[];
        topK: <Value>(
          values: readonly Value[],
          k: number,
          compare?: import("./flat").CompareFunction<Value>,
          direction?: import("./flat").SortDirection,
        ) => Value[];
      };
      sort: {
      ...
      timeseries: {
        bucketByInterval: <Value>(
          points: readonly import("./flat").TimeSeriesPoint<Value>[],
          intervalMs: number,
        ) => import("./flat").TimeBucket<Value>[];
        detectTimeSeriesGaps: <Value>(
          points: readonly import("./flat").TimeSeriesPoint<Value>[],
        ...
        finance: {
          ...
          exponentialMovingAverage: (
            points: readonly import("./flat").TimeSeriesPoint<number>[],
            smoothingFactor?: number,
          ) => import("./flat").TimeSeriesPoint<number>[];
  ...
  traits: {
    compose: {
      mergeTraits: <TLeft extends object, TRight extends object>(
        left: TLeft,
        right: TRight,
        options?: import("../traits/compose/merge").MergeTraitsOptions,
      ) => TLeft & TRight;
    ...
    composeTraitDescriptors: <
      ...
      const TDescriptors extends readonly {
    ...
    >(
      ...
      options?: import("./flat").ComposeTraitDescriptorsOptions<TState>,
    ) => import("./flat").ComposedTraitDescriptorsResult<
      TState,
      (
        (
          (
            TDescriptors[number] extends infer T
              ? T extends TDescriptors[number]
                ? T extends import("./flat").TraitDescriptor<string, object, infer TProvides extends object>
                  ? TProvides
                  : never
                : never
              : never
            ...
            ? T_1 extends (
                TDescriptors[number] extends infer T_2
                  ? T_2 extends TDescriptors[number]
                    ? T_2 extends import("./flat").TraitDescriptor<string, object, infer TProvides extends object>
                      ? TProvides
                      : never
                    : never
                  : never
        ...
        ? object &
            ((
              (
                TDescriptors[number] extends infer T_3
                  ? T_3 extends TDescriptors[number]
                    ? T_3 extends import("./flat").TraitDescriptor<string, object, infer TProvides extends object>
                      ? TProvides
                      : never
                    : never
                  : never
                ...
                ? T_4 extends (
                    TDescriptors[number] extends infer T_5
                      ? T_5 extends TDescriptors[number]
                        ? T_5 extends import("./flat").TraitDescriptor<string, object, infer TProvides extends object>
                          ? TProvides
                          : never
                        : never
                      : never
        ...
        : Record<string, never>
    >;
    createTraitDescriptor: <const TName extends string, TState extends object, TProvides extends object>(
      descriptor: import("./flat").TraitDescriptorInput<TName, TState, TProvides>,
    ) => import("./flat").TraitDescriptor<TName, TState, TProvides>;
    ...
    >(
      jsDoc: string,
      descriptor: import("./flat").TraitDescriptorFromJsDocInput<TName, TState, TProvides>,
    ) => import("./flat").TraitDescriptor<TName, TState, TProvides>;
    mergeTraits: <TLeft extends object, TRight extends object>(
      left: TLeft,
      right: TRight,
