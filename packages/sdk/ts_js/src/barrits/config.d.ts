 ...
 */
export declare const BARRITS_CONFIG_FILENAMES: readonly ["barrits.config.ts", "barrits.config.mts", "barrits.config.js", "barrits.config.mjs"];
/**
 ...
 */
export declare const loadBarritsConfig: (projectRoot?: string) => Promise<(BarritsRootConfig & {
    configFilePath?: string;
}) | null>;
/**
