 ...
 */
export declare const collectPublicNamespaceEntries: (rootFiles: readonly BarritsFileIntegration[], domains: readonly BarritsDomainIntegration[]) => PublicNamespaceEntry[];
/**
 ...
 */
export declare const collectCollisions: (projectRootFiles: readonly BarritsFileIntegration[], projectDomains: readonly BarritsDomainIntegration[], libraryRootFiles: readonly BarritsFileIntegration[], libraryDomains: readonly BarritsDomainIntegration[]) => BarritsExportCollision[];
export {};
