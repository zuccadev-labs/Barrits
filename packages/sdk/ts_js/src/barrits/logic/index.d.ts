...
export declare const logic: {
  ...
  algorithms: {
    ...
    graph: {
      breadthFirstSearch: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
        startNode: NodeId,
      ) => NodeId[];
      buildAdjacencyList: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
        options?: {
      ...
      depthFirstSearch: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
        startNode: NodeId,
      ) => NodeId[];
      dijkstraShortestPath: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
        startNode: NodeId,
        targetNode: NodeId,
      ) => import("..").GraphPath<NodeId>;
      maxFlow: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
        source: NodeId,
        sink: NodeId,
      ) => import("..").MaxFlowResult<NodeId>;
      minimumSpanningTree: <NodeId extends import("..").GraphNodeId>(
        edges: readonly import("..").GraphEdge<NodeId>[],
      ) => import("..").MinimumSpanningTreeResult<NodeId>;
    ...
    search: {
      ...
      findSortedRange: <Value>(
        values: readonly Value[],
        target: Value,
        compare?: import("..").CompareFunction<Value>,
      ) => import("..").SortedRangeMatch;
    ...
    selection: {
      ...
      ) => import("..").PartitionResult<Value>;
      rankBy: <Value>(
        values: readonly Value[],
        criteria: readonly import("..").OrderCriterion<Value>[],
      ) => import("..").RankedValue<Value>[];
      topK: <Value>(
        values: readonly Value[],
        k: number,
        compare?: import("..").CompareFunction<Value>,
    ...
    timeseries: {
      bucketByInterval: <Value>(
        points: readonly import("..").TimeSeriesPoint<Value>[],
        intervalMs: number,
      ) => import("..").TimeBucket<Value>[];
      ...
      finance: {
        ...
        exponentialMovingAverage: (
          points: readonly import("..").TimeSeriesPoint<number>[],
          smoothingFactor?: number,
        ) => import("..").TimeSeriesPoint<number>[];
