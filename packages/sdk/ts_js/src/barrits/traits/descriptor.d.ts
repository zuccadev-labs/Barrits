...
export type TraitDescriptor<TName extends string = string, TState extends object = Record<string, never>, TProvides extends object = Record<string, never>> = {
    readonly name: TName;
...
export type ComposeTraitDescriptorsOptions<TState extends object> = {
    ...
    readonly resolveConflict?: (key: string, leftValue: unknown, rightValue: unknown, leftTraitName: string, rightTraitName: string) => unknown;
};
...
type MergeTraitProvides<TDescriptors extends readonly AnyTraitDescriptor[]> = UnionToIntersection<TraitProvides<TDescriptors[number]>> extends object ? UnionToIntersection<TraitProvides<TDescriptors[number]>> : Record<string, never>;
/**
 ...
 */
export declare const createTraitDescriptor: <const TName extends string, TState extends object, TProvides extends object>(descriptor: TraitDescriptorInput<TName, TState, TProvides>) => TraitDescriptor<TName, TState, TProvides>;
/**
 ...
 */
export declare const createTraitDescriptorFromJsDoc: <const TName extends string = string, TState extends object = Record<string, never>, TProvides extends object = Record<string, never>>(jsDoc: string, descriptor: TraitDescriptorFromJsDocInput<TName, TState, TProvides>) => TraitDescriptor<TName, TState, TProvides>;
/**
 ...
 */
export declare const composeTraitDescriptors: <TState extends object = Record<string, never>, const TDescriptors extends readonly AnyTraitDescriptor[] = readonly AnyTraitDescriptor[]>(descriptors: TDescriptors, options?: ComposeTraitDescriptorsOptions<TState>) => ComposedTraitDescriptorsResult<TState, MergeTraitProvides<TDescriptors>>;
export {};
